...
export default function StoryIntro() {
 const { t } = useLanguage();
 return <div className="story-intro relative z-20 flex min-h-[52vh] items-start pb-12 pt-20 md:min-h-[58vh] md:pb-16 md:pt-24"><div className="w-full">
