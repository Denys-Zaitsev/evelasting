...
export default function Footer(){
 ...
 const nav=[{name:t("music"),href:sectionHref("music")},{name:t("story"),href:sectionHref("story")},{name:t("about"),href:"/about"},{name:t("contact"),href:sectionHref("contact")},{name:t("privacy"),href:"/privacy"}];
