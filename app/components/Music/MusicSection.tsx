...
export default function MusicSection() {
  const { t } = useLanguage();
  return (
    <section id="music" className="music-section relative isolate overflow-hidden border-t border-white/10 bg-black px-6 py-28 md:px-12 lg:py-36">
      <BackgroundEffects />
      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        <motion.div initial={{ opacity: 0, y: 45 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.25 }} transition={{ duration: 0.8, ease: [0.16, 1, 0.3, 1] }} className="grid gap-7 lg:grid-cols-[1.35fr_0.65fr] lg:items-end">
          <div>
            ...
            <h2 className="mt-5 max-w-4xl text-4xl font-semibold tracking-[-0.045em] text-white sm:text-5xl lg:text-7xl">{t("nowPlaying")}</h2>
          </div>
        ...
        <div className="mt-28 border-t border-white/10 pt-24 lg:mt-36 lg:pt-32">
